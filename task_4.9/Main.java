...
public class Main {
    public static void main(String[] args) {
        Person person0 = new Person("Роман", "Иванов", 63, null, null);
        Person person1 = new Person("Мария", "Сидорова", 62, null, null);
        Person person2 = new Person("Федор", "Сидоров", 61, null, null);
        Person person3 = new Person("Клава", "Иванова", 59, null, null);
        Person person4 = new Person("Иван", "Иванов", 30, person3, person0);
        Person person5 = new Person("Ева", "Иванова", 30, person1, person2);
