...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Введите число градусов Цельсия");

        int tc = chislo.nextInt();

        System.out.println("Температура по Фаренгейту составит: ");

        System.out.println(9.0*tc/5+32);
